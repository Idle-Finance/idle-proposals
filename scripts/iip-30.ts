...
// This proposal is the same as IIP-29 with only title changed (IIP-29 didn't reached quorum)
const iipDescription = "IIP-30: Remove idleDAI wrapper for cpFOL-USDC (DAI) senior. Same for idleUSDC with cpWIN-USDC. Remove idleRAI, idleSUSD, idleTUSD and idleFEI from IdleController. Update voting delay in Governor \n https://gov.idle.finance/t/iip-29-assets-by-delisting-by-yield-sources-update-governor-update/1096";

export default task("iip-30", iipDescription).setAction(async (_, hre) => {
