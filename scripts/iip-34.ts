...
const iipDescription = "IIP-34: Upgrade Clearpool portofino (AA tranche) wrapper for IdleDAI to fix availableLiquidity";

export default task("iip-34", iipDescription).setAction(async (_, hre) => {
  _hre = hre;
  ...
  const wrapper = '0x6FA86028323Ba310FE4488F74085De99Ed0264d8'; // cpPOR-DAI AA
  // New protocol tokens
  const protocolToken = addresses.AA_cpPOR_DAI.live.toLowerCase();
  // ############# END PARAMS ##########
