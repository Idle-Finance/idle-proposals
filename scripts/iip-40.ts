...
const iipDescription = "IIP-40: Get Leagues funding for M3 2024. Withdraw IDLE from IdleController";

export default task("iip-40", iipDescription).setAction(async (_, hre) => {
  _hre = hre;
